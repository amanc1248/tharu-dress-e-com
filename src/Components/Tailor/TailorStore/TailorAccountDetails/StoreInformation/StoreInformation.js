...
function StoreInformationAddressBook({changeStoreInfoPage}) {
  return (
    <div className="store__information">
      ...
      <div className="address__book__buttons row justify-content-between">
        <div className="address__book__edit__button__container col-6">
          <button className="address__book__edit__button" onClick={changeStoreInfoPage}>EDIT</button>
        </div>
      ...
      <form action="">
        ...
        <div className="account__information__buttons row justify-content-between">
          <div className="edit__button__container col-6">
            <button className="edit__button" onClick={changeStoreInfoPage}>SAVE</button>
          </div>
          <div className="changepassword__button__container col-6">
            <button className="changepassword__button" onClick={changeStoreInfoPage}>CANCEL</button>
          </div>
        </div>
      </form>
    </div>
